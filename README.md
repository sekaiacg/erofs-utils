...
**fs_config:** ```/bin/cnd 1000 1000 0755 capabilities=0x1000001400```  
**files_context:** ```/bin/hw/android\.hardware\.bluetooth@1\.0-service-qti u:object_r:hal_bluetooth_default_exec:s0```  
**mkfs_option:**
```
Filesystem created:    Thu Jan  1 08:00:00 2009
Filesystem UUID:       xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
mkfs.erofs options:    -zlz4hc -T 1230768000 -U xxxxx --fs-config-file=/path/to/configdir/x_fs_config --file-contexts=/path/to/configdir/odm_file_contexts x_repack.img /path/to/src/x
```
---
**cmdline:**
```console
